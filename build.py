...
def prepare_assets():
    ...
    result = subprocess.run([sys.executable, "prepare_assets.py"])
...
def build_executable():
    ...
    cmd = [
        ...
        "--name", "PrepCore",
        "--icon=icon.png",
        "--add-data", "gant_chart:gant_chart",
        "--add-data", "notebooks:notebooks",
        "--add-data", "quiz_banks:quiz_banks",
        "--add-data", "sample_data:sample_data",
        "--add-data", "Logo.png:.",
        "--add-data", "Logo_rounded.png:.",
        "--add-data", "icon.png:.",
        "--add-data", "Classic Alarm Clock - Sound Effect  ProSounds.mp3:.",
        "--add-data", "board_exam.ui:.",
