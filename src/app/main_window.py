...
from app.app_theme import apply_midnight_blue_theme
from app.board_exam import Ui_MainWindow
from app.subject_emoji import SubjectEmojiManager, get_subject_display_name
from app.subject_emoji_dialog import SubjectEmojiDialog
from app.tree_font_utils import apply_hierarchical_font_to_item
from modules.gant_chart import TimeOrganizerController
...
class MainWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        self.images_root = self.assets_root / "images"
        self.audio_root = self.assets_root / "audio"
        self.data_assets_root = self.assets_root / "data"
        ...
        self.legacy_subject_store_path = self.project_root / "subjects.json"
        self.legacy_app_state_path = self.project_root / "app_state.json"
        ...
        self.app_icon_path = self.images_root / APP_ICON_FILENAME
        self.app_logo_path = self.images_root / APP_LOGO_FILENAME
    ...
    def _migrate_legacy_storage(self):
        legacy_roots = (
            (self.data_assets_root / "quiz_banks", self._quiz_banks_root()),
            (self.data_assets_root / "notebooks", self._notebooks_root()),
            (self.data_assets_root / "gant_chart", self._time_organizer_root()),
            (self.project_root / "quiz_banks", self._quiz_banks_root()),
            (self.project_root / "notebooks", self._notebooks_root()),
            (self.project_root / "gant_chart", self._time_organizer_root()),
        )
...
def main() -> int:
    ...
    app_icon_path = _runtime_root() / "assets" / "images" / APP_ICON_FILENAME
